...
- It's recommended to use the icon-only [button](/components/button/#icon-only-buttons), with the [settings icon](/product-foundations/iconography-directory/?q=settings) and a [tooltip](/components/tooltip) stating, "Configure in settings."
