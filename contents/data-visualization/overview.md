...
The GitLab [commit graph](https://gitlab.com/gitlab-org/gitlab-services/design.gitlab.com/-/network/main) is an example of a relational data visualization, as it shows how all of the individual commits are related to the master.
