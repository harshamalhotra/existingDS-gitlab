...
Below are file formats for digital use that can produce RGB and HEX colors correctly:

- `.png`: pixel-based file that supports transparent backgrounds for digital use
- `.jpg`: pixel-based file that offers more compression for digital use
- `.svg`: vector-based file that is ideal for web usage
...
Below are file formats for print use that can produce CMYK and PMS colors correctly:

- `.eps`: vector-based file, ideal for merchandise and embroidery production
- `.jpg`: compressed file format that can be used for photography or small print jobs
- `.pdf`: high-quality, preferred file format for most print needs, such as billboards, documents, banners, flyers, and more.

<figure-img alt="Chart for color and file formats when producing digital or print graphics" label="Color and file formats for digital and print usage" src="/img/brand/color-terminology.svg"></figure-img>
