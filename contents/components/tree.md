...
- Additional content, like an [avatar](/components/avatar), [icon](https://design.gitlab.com/product-foundations/iconography-directory/), [label](/components/label), or description can be attributes of the node.
