...
- Additional content, like an [avatar](/components/avatar), [icon](/product-foundations/iconography-directory/), [label](/components/label), or description can be attributes of the node.
