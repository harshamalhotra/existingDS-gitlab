...
description: This intersection observer component is an invisible watcher that emits events when it appears and dissapears from view.
---

## Examples

<story-viewer component="utilities-intersection-observer" title="GlIntersectionObserver"></story-viewer>

## Code reference

`GlIntersectionObserver` acts a a vue-friendly wrapper around the [intersection observer API](https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API).
...
clickable, and the experience preserved.

### GlIntersectionObserver

<story-viewer component="utilities-intersection-observer" title="GlIntersectionObserver" view-mode="docs"></story-viewer>
