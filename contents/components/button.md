...
1. **Dropdown**: [chevron-down](/product-foundations/iconography-directory/?q=~chevron-down) icon indicating a dropdown menu.
...
- Only use icons from [GitLab's SVG library](/product-foundations/iconography-directory/).
