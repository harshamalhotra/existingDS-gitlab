...
- **Dark**: For [neutral](/product-foundations/color#neutral) backgrounds that are `color.neutral.200` or lighter, or [chromatic](/product-foundations/color#chromatic) backgrounds that are `300` or lighter.
