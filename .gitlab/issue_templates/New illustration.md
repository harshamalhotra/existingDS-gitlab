...
1. [ ] Export the illustration from the [illustration file][illustration-file] in Figma to the **/packages/gitlab-svgs/illustrations** folder. The file name should be lowercase, and use hyphens as a separator between terms. If necessary, place the illustration in one of the sub-directories.
...
1. [ ] After you’ve committed the changes and the pipeline passes, double-check your illustration in the review app and toggle the mode (light/dark) settings. The illustration should change color with no issues.
...
/label ~"UX" ~"Pajamas UI Kit" ~"foundation::illustration"
