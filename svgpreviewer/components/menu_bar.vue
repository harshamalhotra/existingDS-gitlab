      ...
      <div class="gl-flex gl-gap-5">
        ...
        >
          <svg
            ...
            aria-label="GitLab"
          >
            <symbol id="logomark" height="24" width="24" viewBox="0 0 24 24">
              <path
            ...
            <use class="logomark" xlink:href="#logomark" x="0" y="0" width="24" height="24" />
          </svg>
          <span> SVGs </span>
        </nuxt-link>
        <ul class="gl-m-0 gl-flex gl-list-none gl-p-0">
          <li>
