<template>
  <div
    class="md gl-p-5 gl-text-center sm:gl-grid sm:gl-h-screen sm:gl-max-h-screen sm:gl-place-content-center sm:gl-p-7"
  >
    <div class="gl-w-full gl-max-w-xl">
      <div class="gl-mb-5">
      ...
      <h1 class="!gl-mt-0 gl-text-size-h1">
        <slot name="title"></slot>
      </h1>
      <slot name="text"></slot>
      <pre
        v-if="$scopedSlots.details"
        class="language-bash gl-overflow-scroll"
